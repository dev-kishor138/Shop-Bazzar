...
const SignUpForm = () => {
    ...
    const uploadImage = async (event) => {
        ...
        try {
            const res = await fetch(`https://api.imgbb.com/1/upload?expiration=600&key=${process.env.NEXT_PUBLIC_IMAGEBB_API_KEY}`, {
                method: "POST",
                body: formData,
            });
            ...
            toast.dismiss(toastId);
            toast.error(error.message || 'Image not uploaded!');
        }
    }
